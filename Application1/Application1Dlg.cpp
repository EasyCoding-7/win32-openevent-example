...
// CApplication1Dlg 대화 상자



CApplication1Dlg::CApplication1Dlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_APPLICATION1_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CApplication1Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}
...
BEGIN_MESSAGE_MAP(CApplication1Dlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDOK, &CApplication1Dlg::OnBnClickedOk)
	ON_BN_CLICKED(IDCANCEL, &CApplication1Dlg::OnBnClickedCancel)
	ON_BN_CLICKED(IDC_BUTTON1, &CApplication1Dlg::OnBnClickedButton1)
END_MESSAGE_MAP()


// CApplication1Dlg 메시지 처리기
